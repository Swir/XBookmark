...
add(CDN+STABLE+'/swir.js?beta='+Date.now(),()=>{let n=0;const t=setInterval(()=>{n++;if(((window.SWIR_UI99||window.SWIR_UI98)&&window.SWIR_RADAR_DEBUG97)||n>32){clearInterval(t);add(CDN+selfRef+'/swir-notify-100-beta.js?v='+Date.now(),()=>add(CDN+selfRef+'/swir-mod-tabs-100-beta.js?v='+Date.now()))}},250)});
