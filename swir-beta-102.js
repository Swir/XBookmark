/* SWIR 10.2 BETA — clean rebase on working 10.0 friends + 9.9.2 stable R6 base */
(()=>{try{
...
add(CDN+STABLE992+'/swir-stable-992.js?beta102='+Date.now(),()=>{let n=0;const t=setInterval(()=>{n++;if((window.SWIR_UI99&&window.SWIR_RADAR_DEBUG97&&window.SWIR_COLOR_R6)||n>50){clearInterval(t);add(CDN+WORKING10+'/swir-notify-100-beta.js?v=102',()=>add(CDN+WORKING10+'/swir-mod-tabs-100-beta.js?v=102',()=>add(CDN+WORKING10+'/swir-mod-tabs-100-polish.js?v=102',()=>{window.SWIR_CLOUD_VERSION='10.2 BETA — CLEAN REBASE + FRIENDS FIX';add(CDN+selfRef+'/swir-mod-tabs-102-enhance.js?v='+Date.now())}))) }},200)});
