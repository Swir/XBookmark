/* SWIR 10.1 BETA bootstrap — 9.9 stable base + 9.9.1 reply hotfix + Notify + Clean Tabbed MOD */
(()=>{try{
...
add(CDN+STABLE+'/swir.js?beta101='+Date.now(),()=>{let n=0;const t=setInterval(()=>{n++;if(((window.SWIR_UI99||window.SWIR_UI98)&&window.SWIR_RADAR_DEBUG97)||n>32){clearInterval(t);add(CDN+selfRef+'/swir-hotfix-991.js?v='+Date.now(),()=>add(CDN+selfRef+'/swir-notify-100-beta.js?v='+Date.now(),()=>{window.SWIR_CLOUD_VERSION='10.1 BETA — CLEAN UI + COLOR TAB';add(CDN+selfRef+'/swir-mod-tabs-101-beta.js?v='+Date.now(),()=>add(CDN+selfRef+'/swir-mod-tabs-100-polish.js?v='+Date.now(),()=>add(CDN+selfRef+'/swir-mod-101-hotfix.js?v='+Date.now()))) }))}},250)});
