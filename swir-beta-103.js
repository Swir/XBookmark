...
add(CDN+STABLE992+'/swir-stable-992.js?beta103='+Date.now(),()=>{let n=0;const t=setInterval(()=>{n++;if((window.SWIR_UI99&&window.SWIR_RADAR_DEBUG97&&window.SWIR_COLOR_R6)||n>50){clearInterval(t);add(CDN+selfRef+'/swir-notify-103-beta.js?v='+Date.now(),()=>add(CDN+WORKING10+'/swir-mod-tabs-100-beta.js?v=103',()=>add(CDN+WORKING10+'/swir-mod-tabs-100-polish.js?v=103',()=>add(CDN+ENHANCE102+'/swir-mod-tabs-102-enhance.js?v=103',()=>{window.SWIR_CLOUD_VERSION='10.3 BETA — FRIEND NOTIFY REBUILD';add(CDN+selfRef+'/swir-mod-103-polish.js?v='+Date.now())}))))}},200)});
